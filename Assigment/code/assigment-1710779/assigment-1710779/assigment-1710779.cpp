...
{
	glPushMatrix();
	glTranslatef(2.45, 3 + 11.0*cos(((atan((t * sin(m* PI / 180.0)) / (4.0 + t * cos(m*PI / 180.0)))) * 180) / PI * PI / 180), 11.0*sin(((atan((t * sin(m* PI / 180.0)) / (4.0 + t * cos(m*PI / 180.0)))) * 180) / PI * PI / 180));
	glRotatef(90, 0, 0, 1);
	if (nChoice == 0)
	{
		chot1.DrawWireframe();
...
void DrawCube1() {
	glPushMatrix();
	glTranslatef(2.75, 3 + 11.0*cos(((atan((t * sin(m* PI / 180.0)) / (4.0 + t * cos(m*PI / 180.0)))) * 180) / PI * PI / 180), 11.0*sin(((atan((t * sin(m* PI / 180.0)) / (4.0 + t * cos(m*PI / 180.0)))) * 180) / PI * PI / 180));
	if (nChoice == 0)
	{
		cube1.DrawWireframe();
	}
...
void DrawThanhLienKet()
{
	...
	GLfloat specular[] = { 1.0, 1.0, 1.0, 1.0 };
	GLfloat shininess = 40.0;
	shape3_1.addMaterial(ambient, diffuse, specular, shininess);
	shape3_2.addMaterial(ambient, diffuse, specular, shininess);
	shape3_3.addMaterial(ambient, diffuse, specular, shininess);
	glPopMatrix();
}
void DrawGoido1() {
	glPushMatrix();
...
//tạo vật thể
	rectangular.CreateRectangular(14, 5, 1);
	rectangular.SetColor(2);
	rectangular.vectorNewell();

	rectangular1.CreateRectangular(4, 1, 15);
	rectangular1.SetColor(2);
	rectangular1.vectorNewell();

	rectangular2.CreateRectangular(14, 1, 4);
	rectangular2.SetColor(2);
	...
	shape3_1.CreateShape3_1(11, 2, 0.5);
	shape3_1.SetColor(5);
	shape3_1.vectorNewell();

	shape3_2.CreateShape3_2(11, 2, 0.5);
	shape3_2.SetColor(5);
	shape3_2.vectorNewell();

	shape3_3.CreateShape3_3(11, 2, 0.5);
	shape3_3.SetColor(5);
	shape3_3.vectorNewell();

	shape2.CreateShape2(1.5, 0.75, 0.5);
	shape2.SetColor(10);
	shape2.vectorNewell();

	shape1.CreateShape1(2.85, 0.5, 3.25);
	shape1.SetColor(14);
	shape1.vectorNewell();

	cylinder.CreateCylinder(50, 23, 0.5);
	cylinder.SetColor(6);
	cylinder.vectorNewell();

	banquay.CreateCylinder(72, 0.75, 1.9);
	banquay.SetColor(3);
	banquay.vectorNewell();

	chot1.CreateCylinder(36, 1.45, 0.25);
	chot1.SetColor(6);
	chot1.vectorNewell();

	chot2.CreateCylinder(72, 2.1, 0.25);
	chot2.SetColor(6);
	chot2.vectorNewell();

	chot3.CreateCylinder(36, 1.85, 0.4);
	chot3.SetColor(6);
	chot3.vectorNewell();

	cube1.CreateCube(0.42);
	cube1.SetColor(0);
	cube1.vectorNewell();

	cube2.CreateCube(0.35);
	cube2.SetColor(0);
	cube2.vectorNewell();
